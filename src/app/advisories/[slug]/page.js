      ...
      <main style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)', minHeight: '100vh', paddingTop: '100px', paddingBottom: '5rem', fontFamily: 'var(--font-body)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <section style={{ marginBottom: '3rem' }}>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.4rem', color: 'var(--accent-yellow)', marginBottom: '1rem' }}>
              Plain English Explanation
            </h2>
          ...
          <section style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)', padding: '2rem', borderRadius: '4px', marginBottom: '3rem' }}>
            <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', marginBottom: '1.25rem', color: 'var(--text-primary)' }}>
              Failure Likelihood &amp; Timeline
            </h3>
            
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', justify: 'space-between', fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '0.4rem', fontFamily: 'var(--font-mono)' }}>
                <span>Failure Progression Probability</span>
                <span style={{ color: 'var(--accent-red)', fontWeight: 'bold' }}>64%</span>
              </div>
              <div style={{ background: 'var(--bg-primary)', height: '8px', borderRadius: '4px' }}>
                <div style={{ background: 'var(--accent-red)', width: '64%', height: '100%', borderRadius: '4px' }}></div>
              </div>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem', borderTop: '1px solid var(--border-color)', paddingTop: '1.25rem' }}>
              <div>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)', display: 'block' }}>REPAIR TIMELINE</span>
                <strong style={{ fontSize: '1.1rem', color: 'var(--text-primary)' }}>3 — 6 Months</strong>
              </div>
              <div>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)', display: 'block' }}>URGENCY ASSESSMENT</span>
                <strong style={{ fontSize: '1.1rem', color: 'var(--accent-amber)' }}>Medium Risk Warning</strong>
              </div>
            </div>
          </section>
          ...
          <section style={{ marginBottom: '3.5rem' }}>
            ...
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)', padding: '1.5rem', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>AVERAGE REPAIR COST RANGE</div>
              <div style={{ fontSize: '2rem', fontWeight: '900', color: 'var(--text-primary)', fontFamily: 'var(--font-mono)', marginTop: '0.25rem' }}>
                £120 — £280
              </div>
          ...
          {/* Check CTA */}
          <div style={{ background: 'var(--gradient-card)', border: '1px solid var(--accent-yellow)', padding: '3rem 2rem', borderRadius: '4px', textAlign: 'center' }}>
