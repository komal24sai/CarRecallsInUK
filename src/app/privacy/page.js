    ...
    <>
      ...
      <main style={{ background: '#0D0F14', color: '#FFFFFF', minHeight: '100vh', paddingTop: '100px', paddingBottom: '5rem', fontFamily: 'var(--font-body)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 1.5rem', lineHeight: '1.6' }}>
          ...
          <p style={{ color: '#A0AEC0', fontSize: '1.05rem', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.5rem', color: '#E8FF00', marginTop: '2rem', marginBottom: '1rem' }}>
            1. What Data We Collect
          </h2>
          <ul style={{ paddingLeft: '1.25rem', color: '#A0AEC0', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '2rem' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', marginBottom: '2rem', background: '#161922', border: '1px solid #262B38', borderRadius: '4px' }}>
            <thead>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #262B38' }}>
                ...
                <td style={{ padding: '0.75rem', color: '#A0AEC0' }}>Cached for 7 days to support duplicate dealer stock audits.</td>
              </tr>
              <tr style={{ borderBottom: '1px solid #262B38' }}>
                <td style={{ padding: '0.75rem', fontWeight: 'bold' }}>User & Dealer Emails</td>
                <td style={{ padding: '0.75rem', color: '#A0AEC0' }}>Retained for the lifetime of your active platform subscription.</td>
              </tr>
              <tr>
                <td style={{ padding: '0.75rem', fontWeight: 'bold' }}>Payment Transaction Records</td>
                <td style={{ padding: '0.75rem', color: '#A0AEC0' }}>Kept for 6 years to satisfy UK corporate tax reporting guidelines.</td>
              </tr>
            </tbody>
          </table>
          ...
          <p style={{ color: '#A0AEC0', marginBottom: '2rem' }}>
            ...
            <br />
            Email: <strong style={{ color: '#FFFFFF' }}>privacy@isthiscarsafe.co.uk</strong>
          </p>
