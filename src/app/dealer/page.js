...
export default function DealerDashboard() {
  ...
  return (
    <>
      <Header />
      <main style={{ background: '#0D0F14', color: '#FFFFFF', minHeight: '100vh', paddingTop: '90px', paddingBottom: '5rem', fontFamily: 'var(--font-body)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #262B38', paddingBottom: '1.5rem', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1rem' }}>
            <div>
              ...
              <p style={{ color: '#A0AEC0', fontSize: '0.9rem', marginTop: '0.25rem' }}>
                Active Plan: <strong style={{ color: '#E8FF00', textTransform: 'uppercase' }}>{dealerDetails.plan} Tier</strong> · {dealerDetails.email}
              </p>
            </div>
            
            {/* API Key Panel */}
            <div style={{ background: '#161922', border: '1px solid #262B38', padding: '0.75rem 1.25rem', borderRadius: '4px', textAlign: 'right' }}>
              <div style={{ fontSize: '0.75rem', color: '#64748B', fontFamily: 'var(--font-mono)' }}>DEALER API KEY (BEARER TOKEN)</div>
              <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', marginTop: '0.25rem' }}>
                <code style={{ color: '#E8FF00', fontSize: '0.85rem', fontFamily: 'var(--font-mono)' }}>
                ...
                <button
                  ...
                  style={{ background: 'transparent', border: 'none', color: '#A0AEC0', cursor: 'pointer', fontSize: '0.8rem' }}
                >
                  📋 Copy
                </button>
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
            ...
            <div style={{ background: '#161922', border: '1px solid #262B38', borderLeft: '4px solid #F56565', padding: '1.5rem', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.85rem', color: '#64748B', fontFamily: 'var(--font-mono)' }}>EXPOSURES REQUIRING ATTENTION</div>
              <div style={{ fontSize: '2.2rem', fontWeight: '900', color: '#F56565', marginTop: '0.5rem', fontFamily: 'var(--font-mono)' }}>
                {redCriticalCount} <span style={{ fontSize: '1rem', color: '#A0AEC0', fontWeight: 'normal' }}>cars (High/Critical)</span>
              </div>
              <p style={{ fontSize: '0.8rem', color: '#64748B', marginTop: '0.5rem' }}>Fails next scheduled MOT test indicators</p>
            </div>

            <div style={{ background: '#161922', border: '1px solid #262B38', borderLeft: '4px solid #E8FF00', padding: '1.5rem', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.85rem', color: '#64748B', fontFamily: 'var(--font-mono)' }}>AVG REPAIR LIABILITY / CAR</div>
              <div style={{ fontSize: '2.2rem', fontWeight: '900', color: '#FFFFFF', marginTop: '0.5rem', fontFamily: 'var(--font-mono)' }}>
                £{totalAvgExposure}
              </div>
              <p style={{ fontSize: '0.8rem', color: '#64748B', marginTop: '0.5rem' }}>Independent garage rate averages</p>
            </div>

            <div style={{ background: '#161922', border: '1px solid #262B38', borderLeft: '4px solid #3182CE', padding: '1.5rem', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.85rem', color: '#64748B', fontFamily: 'var(--font-mono)' }}>OUTSTANDING SAFETY RECALLS</div>
              <div style={{ fontSize: '2.2rem', fontWeight: '900', color: '#3182CE', marginTop: '0.5rem', fontFamily: 'var(--font-mono)' }}>
                {outstandingRecallsCount} <span style={{ fontSize: '1rem', color: '#A0AEC0', fontWeight: 'normal' }}>active alerts</span>
              </div>
              <p style={{ fontSize: '0.8rem', color: '#64748B', marginTop: '0.5rem' }}>Cross-referenced manufacturer defects</p>
            </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <div>
                <label style={{ fontSize: '0.75rem', color: '#64748B', display: 'block', marginBottom: '0.25rem' }}>Risk Level</label>
                <select
                  value={filterRisk}
                  onChange={(e) => setFilterRisk(e.target.value)}
                  style={{ background: '#161922', color: '#FFFFFF', border: '1px solid #262B38', padding: '0.5rem 1rem', borderRadius: '4px' }}
                >
              ...
              <div>
                <label style={{ fontSize: '0.75rem', color: '#64748B', display: 'block', marginBottom: '0.25rem' }}>Manufacturer</label>
                <select
                  value={filterMake}
                  onChange={(e) => setFilterMake(e.target.value)}
                  style={{ background: '#161922', color: '#FFFFFF', border: '1px solid #262B38', padding: '0.5rem 1rem', borderRadius: '4px', textTransform: 'capitalize' }}
                >
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <button
                ...
                style={{ background: 'transparent', color: '#FFFFFF', border: '1px solid #262B38', padding: '0.6rem 1.25rem', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer' }}
              >
                📥 Export CSV
              </button>
              <button
                onClick={() => setShowBulkModal(true)}
                style={{ background: '#E8FF00', color: '#0D0F14', border: 'none', padding: '0.6rem 1.25rem', borderRadius: '4px', fontWeight: '900', cursor: 'pointer', boxShadow: 'var(--shadow-glow)' }}
              >
                ➕ Add Plates (Bulk)
              </button>
            </div>
          ...
          {/* STOCK TABLE VIEW */}
          <div style={{ background: '#161922', border: '1px solid #262B38', borderRadius: '6px', overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '850px' }}>
              <thead>
                <tr style={{ background: '#12151C', borderBottom: '2px solid #262B38', fontSize: '0.85rem', color: '#64748B', fontFamily: 'var(--font-mono)' }}>
              ...
              <tbody>
                {processedStock.map((car, index) => {
                  ...
                  return (
                    <>
                      <tr key={index} style={{ borderBottom: '1px solid #262B38', cursor: 'pointer', hover: { background: '#202532' } }} onClick={() => toggleRow(index)}>
                        {/* Plate */}
                        ...
                        {/* MOT Due months */}
                        <td style={{ padding: '1.25rem', fontFamily: 'var(--font-mono)', color: car.mot_due_months <= 3 ? '#F56565' : '#FFFFFF' }}>
                        ...
                        <td style={{ padding: '1.25rem', textAlign: 'center' }}>
                          <button
                            style={{ background: 'transparent', border: 'none', color: '#E8FF00', fontWeight: 'bold', cursor: 'pointer' }}
                          >
                      ...
                      {car.expanded && (
                        <tr>
                          <td colSpan={7} style={{ background: '#0D0F14', padding: '2rem', borderBottom: '1px solid #262B38' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                              
                              <div>
                                <h4 style={{ fontFamily: 'var(--font-heading)', color: '#E8FF00', marginBottom: '1rem', fontSize: '1rem' }}>
                                  Advisory Failure Analysis
                                </h4>
                                {car.advisory_count > 0 ? (
                                  <ul style={{ paddingLeft: '1.25rem', color: '#A0AEC0', display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.88rem' }}>
                                    ...
                                    {car.recalls_outstanding > 0 && (
                                      <li style={{ color: '#F56565' }}>⚠️ Outstanding recall: Steering column bolt fracture risk</li>
                                    )}
                                  </ul>
                                ) : (
                                  <p style={{ color: '#64748B', fontSize: '0.9rem', fontStyle: 'italic' }}>No active pre-failure advisories located for this vehicle.</p>
                                )}
                              </div>

                              <div style={{ textAlign: 'right' }}>
                                <h4 style={{ fontFamily: 'var(--font-heading)', color: '#FFFFFF', marginBottom: '0.75rem', fontSize: '1rem' }}>
                                  Condition Report
                                </h4>
                                ...
                                {dealerDetails.plan === 'pro' ? (
                                  ...
                                  <span style={{ color: '#64748B', fontSize: '0.85rem', display: 'block' }}>
      ...
      {showBulkModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 }}>
          <div style={{ background: '#161922', border: '1px solid #262B38', borderRadius: '6px', padding: '2.5rem', maxWidth: '500px', width: '100%', position: 'relative' }}>
            
            <button
              onClick={() => setShowBulkModal(false)}
              style={{ position: 'absolute', top: '15px', right: '15px', background: 'none', border: 'none', color: '#A0AEC0', fontSize: '1.5rem', cursor: 'pointer' }}
            >
              &times;
            </button>
            ...
            <form onSubmit={handleBulkAdd} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <textarea
                ...
                style={{ width: '100%', background: '#0D0F14', border: '1px solid #262B38', borderRadius: '4px', padding: '0.75rem', color: '#FFFFFF', outline: 'none', fontFamily: 'var(--font-mono)', fontSize: '1rem', resize: 'vertical' }}
              />
