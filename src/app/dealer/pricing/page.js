    ...
    <>
      ...
      <main style={{ background: '#0D0F14', color: '#FFFFFF', minHeight: '100vh', paddingTop: '100px', paddingBottom: '5rem', fontFamily: 'var(--font-body)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem', textAlign: 'center' }}>
          ...
          <span style={{ background: '#161922', border: '1px solid #262B38', color: '#E8FF00', padding: '0.4rem 1rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px' }}>
          ...
          <p style={{ color: '#A0AEC0', fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto 4rem', lineHeight: '1.6' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2.5rem', marginBottom: '5rem' }}>
            ...
            {/* Basic Plan */}
            <div style={{ background: '#161922', border: '1px solid #262B38', borderRadius: '6px', padding: '3rem 2rem', textAlign: 'left', display: 'flex', flexDirection: 'column' }}>
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.8rem', marginBottom: '0.5rem' }}>Basic</h2>
              <p style={{ color: '#64748B', fontSize: '0.95rem', marginBottom: '2rem' }}>Ideal for local independent dealers.</p>
              
              <div style={{ marginBottom: '2rem' }}>
                <span style={{ fontSize: '3rem', fontWeight: '900', fontFamily: 'var(--font-mono)' }}>£49</span>
                <span style={{ color: '#A0AEC0' }}> / month</span>
              </div>
            ...
            {/* Pro Plan */}
            <div style={{ background: '#161922', border: '1px solid #E8FF00', borderRadius: '6px', padding: '3rem 2rem', textAlign: 'left', display: 'flex', flexDirection: 'column', position: 'relative' }}>
              ...
              <p style={{ color: '#64748B', fontSize: '0.95rem', marginBottom: '2rem' }}>Perfect for multi-site dealerships.</p>
          ...
          {/* FAQ SECTION */}
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'left', borderTop: '1px solid #262B38', paddingTop: '4rem' }}>
      ...
      {showModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 }}>
          <div style={{ background: '#161922', border: '1px solid #262B38', borderRadius: '6px', padding: '2.5rem', maxWidth: '450px', width: '100%', position: 'relative' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#A0AEC0', marginBottom: '0.5rem' }}>Business Name</label>
                <input
                  type="text"
                  name="businessName"
                  ...
                  style={{ width: '100%', background: '#0D0F14', border: '1px solid #262B38', borderRadius: '4px', padding: '0.75rem', color: '#FFFFFF', outline: 'none' }}
                />
              </div>

              <div>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#A0AEC0', marginBottom: '0.5rem' }}>Business Email</label>
                <input
                  type="email"
                  name="email"
              ...
              {error && (
                <div style={{ color: '#F56565', fontSize: '0.85rem', fontWeight: 'bold' }}>
                  ❌ {error}
                </div>
              )}
