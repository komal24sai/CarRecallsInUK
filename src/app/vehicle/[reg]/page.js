...
export default function VehiclePage({ params }) {
  ...
  const renderSpecifications = () => {
    return (
      <div style={{ background: '#161922', borderRadius: '6px', border: '1px solid #262B38', padding: '2rem' }}>
  ...
  const renderTimeline = () => {
    return (
      <div style={{ background: '#161922', borderRadius: '6px', border: '1px solid #262B38', padding: '2.5rem' }}>
  ...
  const renderSeoLink = () => {
    ...
    return (
      <div style={{ background: '#161922', borderRadius: '6px', border: '1px solid #262B38', padding: '1.25rem 2rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: '0.7rem', color: '#FFF', fontWeight: 'bold', fontFamily: 'var(--font-mono)', lineHeight: '1.3' }}>
                  {item.name}
                </span>
                <span style={{ 
                  position: 'absolute', 
  ...
  const renderChecklist = () => {
    return (
      <div style={{ background: '#161922', borderRadius: '6px', border: '1px solid #262B38', padding: '1.5rem 2rem' }}>
    ...
    return (
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ filter: isUnlocked ? 'none' : 'blur(2.5px)', opacity: isUnlocked ? 1 : 0.25 }}>
          ...
          {/* COST SUMMARY BOX */}
          <div style={{ background: 'rgba(232, 255, 0, 0.08)', borderRadius: '6px', border: '1px solid #E8FF00', padding: '2.5rem', position: 'relative' }}>
